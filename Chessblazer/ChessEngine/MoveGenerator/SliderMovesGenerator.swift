...
func generateRookMoves(bitboards: [Int: Bitboard], currentColor: Piece.Color, square: Int, moves: inout [Move], occupancy: Occupancy) {
...
func generateRookMovesForQueen(bitboards: [Int: Bitboard], currentColor: Piece.Color, square: Int, moves: inout [Move], occupancy: Occupancy) {
    let blockerBitboard = occupancy.all & Rook.masks[square]
    var movesBitboard = Rook.lookUpTable[square]![magicIndex(magic: rookMagics[square], shift: rookShifts[square], blocker: blockerBitboard)]!
    var pieceValue = 0
...
func generateBishopMoves(bitboards: [Int: Bitboard], currentColor: Piece.Color, square: Int, moves: inout [Move], occupancy: Occupancy) {
...
func generateBishopMovesForQueen(bitboards: [Int: Bitboard], currentColor: Piece.Color, square: Int, moves: inout [Move], occupancy: Occupancy) {
    let blockerBitboard = occupancy.all & Bishop.masks[square]
    var movesBitboard = Bishop.lookUpTable[square]![magicIndex(magic: bishopMagics[square], shift: bishopShifts[square], blocker: blockerBitboard)]!
...
func generateQueenMoves(bitboards: [Int: Bitboard], currentColor: Piece.Color, square: Int, moves: inout [Move], occupancy: Occupancy) {
    var queenMoves = [Move]()
